...
public class AAR016ContactPropertiesCheckTest extends BaseCheckTest {
    ...
    public void verifyRule() {
        assertRuleProperties("AAR016 - ContactProperties - The object cannot be empty, adding the contact helps people where to go for help", RuleType.BUG, Severity.MAJOR, tags("format"));
    }
}
