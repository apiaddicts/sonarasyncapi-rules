...
public abstract class BaseCheckTest {
    ...
    private void verify(String file, boolean isV2, boolean isV3, boolean isV31) {
        ...
        if (filePath.contains(".")) {
            ...
            ExtendedAsyncApiCheckVerifier.verify(filePath, check, isV2, isV3, isV31);
        } else {
            LOG.info("Testing file : " + filePath + ".yaml");
            ExtendedAsyncApiCheckVerifier.verify(filePath + ".yaml", check, isV2, isV3, isV31);
            LOG.info("Testing file : " + filePath + ".json");
            ExtendedAsyncApiCheckVerifier.verify(filePath + ".json", check, isV2, isV3, isV31);
        }
    }
